...
Redis::Redis(const std::string &uri) : Redis(_parse_options(uri)) {}
...
ConnectionOptions Redis::_parse_options(const std::string &uri) const {
    std::string type;
    std::string path;
...
ConnectionOptions Redis::_parse_tcp_options(const std::string &path) const {
    ConnectionOptions options;
...
ConnectionOptions Redis::_parse_unix_options(const std::string &path) const {
    ConnectionOptions options;
