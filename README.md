...
*redis-plus-plus* also partially supports Windows platform, and it has been fully tested with Visual Studio 2019 on Win 10. I'm not familiar with Visual Studio environment. If you're familiar with it, feel free to update this doc on how to install it on Windows, and help to test it with Visual Studio 2017 or other compilers.

With Visual Studio 2019, you can edit the *CMakeLists.json* file, generated by Visual Studio, to set cmake options mentioned above with the following exceptions:

- REDIS_PLUS_PLUS_CXX_STANDARD: this option is not supported on Windows so far.
- CMAKE_PREFIX_PATH: instead of set *CMAKE_PREFIX_PATH*, you can set *HIREDIS_HEADER*, *HIREDIS_LIB* and *HIREDIS_STATIC_LIB* to specify the installation path of hiredis headers, installation path of hiredis dynamic library and installation path of hiredis static library.

**NOTE**: you need to install *hiredis* v1.0.0 or later.
